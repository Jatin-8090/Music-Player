...
class MusicPlayer:
    ...
    def __init__(self, root):
        ...
        self.bg_image =  tk.PhotoImage(file = os.path.join(os.getcwd(), "music player/images", "images (1).png"))
        ...
        self.bg_image3 =  tk.PhotoImage(file = os.path.join(os.getcwd(), "music player/images", "images.png"))
